...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { nome: @funcionario.nome, numero_id: @funcionario.numero_id, telemovel: @funcionario.telemovel, tipo_de_id: @funcionario.tipo_de_id } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { nome: @funcionario.nome, numero_id: @funcionario.numero_id, telemovel: @funcionario.telemovel, tipo_de_id: @funcionario.tipo_de_id } }
