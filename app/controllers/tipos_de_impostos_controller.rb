class TiposDeImpostosController < ApplicationController
  before_action :set_tipo_de_imposto, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_de_imposto.save
        format.html { redirect_to @empresa, notice: 'Tipo de imposto was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipo_de_imposto.update(tipo_de_imposto_params)
        format.html { redirect_to @empresa, notice: 'Tipo de imposto was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @empresa, notice: 'Tipo de imposto was successfully destroyed.' }
  ...
  private
    ...
    def tipo_de_imposto_params
      params.require(:tipo_de_imposto).permit(:tipo, :motivo, :percentagem, :valor, :empresa_id)
    end
end
